...
func newShowpaths(pather CommandPather) *cobra.Command {
	...
	var cmd = &cobra.Command{
		...
		Example: fmt.Sprintf(
			`  %[1]s showpaths 1-ff00:0:110 --extended
