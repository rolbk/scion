sudo ./scion.sh topology -c topology/triangle.topo -n 10.0.0.0/8
...
do
  ...
  with_entries(
	...
	rm -r lab-autogen-triangle/scion0$i/etc/scion
	cp -R gen/ASffaa_1_$i/ lab-autogen-triangle/scion0$i/etc/scion
done
